/**
 * Das Modul "Eingabeformular" ist für das Eingaeformular der Anwendung zuständig.
    ...
    _absenden_event_hinzufuegen(eingabeformular) {
        eingabeformular.querySelector("#eingabeformular").addEventListener("submit", e => {
            ...
            if (formular_fehler.length === 0) {
                ...
                let fehler = new Fehler("Folgende Felder wurden nicht korrent ausgefüllt", formular_fehler);
                fehler.anzeigen();
            }   
        });
    }
